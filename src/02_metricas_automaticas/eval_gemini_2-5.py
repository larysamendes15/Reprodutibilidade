"""
Script de avaliação das respostas do GEMINI 2.5 Pro no experimento de QA.

Supõe que o qa_gemini.py gerou um CSV no formato:

    saidas/gemini-2.5-pro_QAG.csv
...
Requisitos:
    ...
    pip install pandas rouge sacrebleu bert-score torch matplotlib
"""
...
# Caminho do CSV gerado pelo qa_gemini.py
CSV_INPUT = Path("results/legacy/gemini-2.5-pro_QAG.csv")

# Caminho do CSV de saída com as métricas agregadas
CSV_OUTPUT = Path("results/legacy/gemini-2.5-pro_metrics.csv")

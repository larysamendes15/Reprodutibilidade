"""
Script de avaliação das respostas do GPT no experimento de QA.

Supõe que o qa_gpt.py gerou um CSV no formato:

    saidas/gpt-5.1_QAG.csv

com colunas:
    Q        -> pergunta
    A        -> resposta ouro (gold)
    A_model  -> resposta do modelo GPT
...
def main():
    ...
    print(f"Lendo respostas do GPT em: {CSV_INPUT}")
